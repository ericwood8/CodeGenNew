...
public class TableModel
{
    ...
    // two plain FK columns, e.g. a real ProvidenceOgas.dbo.NameBaseGroupXref -- confirmed against a live
    // database, 2026-09-25, to be the more common shape, not the composite-key one first assumed). Purely
