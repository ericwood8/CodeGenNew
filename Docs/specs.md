...
- Twenty-four shipped templates (nine stored procedure templates, two API templates, four C# templates, five Angular TypeScript templates and four WinUI3 templates; all in `Templates\`; on disk they are `SP_Insert_v1.tt` etc. — see §8.0 — while this document uses the unversioned names), each tested against a real database using the manual protocol above:
